...
@store1.employees.create(first_name: "Clementine", last_name: "Anabel", hourly_rate: 85)
@store1.employees.create(first_name: "Ella", last_name: "Persephone", hourly_rate: 42)
@store2.employees.create(first_name: "Grant", last_name: "Hughes", hourly_rate: 123)
